package com.satish.cards.controller;
...
import com.satish.cards.dto.ErrorResponseDto;
import com.satish.cards.dto.ResponseDto;
...
public class CardsController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardsDto> fetchCardDetails(@RequestHeader("banking-correlation-id") String correlationdId, @RequestParam
                                                               @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                               String mobileNumber) {
